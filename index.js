module.exports = {
    ...
    search_users                            : require('./features/search_users'),
    search_users_with_paging                : require('./features/search_users_with_paging'),
    get_single_user_by_id                   : require('./features/get_single_user_by_id'),
    get_single_user_by_username_or_email    : require('./features/get_single_user_by_username_or_email'),
    user_update                             : require('./features/user_update'),
    get_orgs                                : require('./features/get_orgs'),
    get_teams                               : require('./features/get_teams'),
    get_actual_user                         : require('./features/get_actual_user'),
    change_password                         : require('./features/change_password'),
    switch_user_context_for_specified_user  : require('./features/switch_user_context_for_specified_user'),
    switch_user_context_for_signed_in_user  : require('./features/switch_user_context_for_signed_in_user'),
    orgs_of_actual_user                     : require('./features/orgs_of_actual_user'),
    get_user_teams                          : require('./features/get_user_teams'),
    star_a_dashboard                        : require('./features/star_a_dashboard'),
