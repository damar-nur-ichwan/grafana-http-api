...
// index.get_current_org()
// index.get_current_org_users()
// index.get_current_org_users_lookup()
// index.updates_the_given_user(1,'Admin')
// index.delete_user_in_current_org(1)
// index.update_current_org('Update Current Org')
// index.add_user_to_the_current_org('Admin','damar')
// index.get_org_by_id(1)
// index.get_org_by_name('Update Current Org')
// index.search_all_orgs(100,0)
// index.update_org(1,'trial org')
// index.delete_org(1)
// index.get_org_users(1)
